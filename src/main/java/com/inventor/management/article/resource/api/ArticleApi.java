package com.inventor.management.article.resource.api;
...
import static com.inventor.management.article.roots.ArticleEndPoint.*;

public interface ArticleApi {
    @PostMapping(value = ARTICLE_ENDPOINT,
            consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    @Operation(summary = "Save article", description = "This method allow to save an article", tags = {"Article"})
    @ApiResponses(value = {
    ...
    @PutMapping(value = UPDATE_ARTICLE_ENDPOINT,
            consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    @Operation(summary = "Update article", description = "This method allow to update an article", tags = {"Article"})
    @ApiResponses(value = {
    ...
    @GetMapping(value = FIND_ARTICLE_BY_ID,
            consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    @Operation(summary = "Find out an article by ID",
            description = "This method allow to find out an article with ID", tags = {"Article"})
    @ApiResponses(value = {
    ...
    @GetMapping(value = FIND_ARTICLE_BY_CODE_ARTICLE,
            consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    @Operation(summary = "Find out an article by code_article",
            description = "This method allow to find out an article with code_article",tags = {"Article"})
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Article has been found in DB"),
            @ApiResponse(responseCode = "403", description = "Unauthorized access for this objet"),

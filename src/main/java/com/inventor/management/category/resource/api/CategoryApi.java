package com.inventor.management.category.resource.api;
...
import static com.inventor.management.category.roots.CategoryEndPoint.*;
...
public interface CategoryApi {
    ...
    @Operation(
            ...
            description = "This method allow to find out a category with ID",tags = {"CategoryDto"}
    )
    @ApiResponses(
            value = {

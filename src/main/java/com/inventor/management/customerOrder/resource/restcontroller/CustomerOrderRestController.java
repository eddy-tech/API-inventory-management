package com.inventor.management.customerOrder.resource.restcontroller;
...
import com.inventor.management.customerOrder.service.CustomerOrderService;
import com.inventor.management.customerOrder.resource.api.CustomerOrderApi;
...
import static com.inventor.management.customerOrder.roots.CustomerOrderEndPoint.CUSTOMER_ORDER_ENDPOINT;
...
public class CustomerOrderRestController implements CustomerOrderApi {
    ...
    @Override
    public ResponseEntity<CustomerOrderDto> updateCustomerOrder(Long customerOrderId, CustomerOrderDto customerOrderDto) {

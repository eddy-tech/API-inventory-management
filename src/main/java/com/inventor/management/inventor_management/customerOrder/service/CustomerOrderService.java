package com.inventor.management.inventor_management.customerOrder.service;
...
public interface CustomerOrderService {
    CustomerOrderDto saveCustomerOrder (CustomerOrderRequest customerOrderRequest);
    CustomerOrderDto updateCustomerOrder (CustomerOrderRequest customerOrderRequest, Long id);

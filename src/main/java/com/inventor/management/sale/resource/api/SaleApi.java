package com.inventor.management.sale.resource.api;
...
import static com.inventor.management.sale.roots.SaleEndPoint.*;

public interface SaleApi {
    @PostMapping(value = SALE_ENDPOINT)
    @Operation(
            summary = "Save Sale",
    ...
    @GetMapping(value = FIND_SALE_BY_ID)
    @Operation(
    ...
    @GetMapping(value = FIND_SALE_BY_CODE_SALE)
    @Operation(
    ...
    @GetMapping(value = SALE_ENDPOINT)
    @Operation(
    ...
    @DeleteMapping(value = DELETE_SALE)
    @Operation(
